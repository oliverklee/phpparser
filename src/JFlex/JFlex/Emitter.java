...
final public class Emitter {
  ...
  private void emitScanError() {
    ...
    // NJ: we want file name and line number in case of an error
    println("    message = message + \"; file \" + fileName + \", line \" + yyline;");
  ...
  private void emitConstructorDecl() {
    ...
    // NJ: for more() functionality
    println("    this.morePrefix = new StringBuffer();");
    println("    this.clearMorePrefix = true;");
